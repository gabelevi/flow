...
ignore_implementation_files() {
  ...
  mv foo/bar/nested_test.js foo/bar/nested_test.js.ignored
...
use_implementation_files() {
  ...
  mv foo/bar/nested_test.js.ignored foo/bar/nested_test.js
